...
class Cli_CastleBuildDefense {
    ...
    public function __construct($castleId, $user, $db, $gameHandler) {
        ...
        $defenseModifier = Cli_Database::getCastleDefenseModifier($user->parameters['gameId'], $castleId, $db);
        ...
        Cli_Database::buildDefense($user->parameters['gameId'], $castleId, $user->parameters['playerId'], $db);
