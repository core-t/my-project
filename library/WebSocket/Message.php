...
/**
 * WebSocket_Message compatible with the Hixie Draft #76
...
/**
 * WebSocket_Message compatible with the latest draft.
 * Should be updated to keep up with the latest changes.
 *
 * @author Chris
 *
 */
class WebSocket_Message implements IWebSocketMessage {
    ...
    protected function createFrames() {
        $this->frames = array(WebSocket_Frame::create(WebSocketOpcode::TextFrame, $this->data));
    }
     ...
     */
    public function takeFrame(WebSocket_Frame $frame) {
        $this->frames[] = $frame;
    }
